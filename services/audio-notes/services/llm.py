...
def chat_with_context_streaming(message: str, history: list, transcript: str, summary: str = "", model: Optional[str] = None, prepare_gpu: bool = True):
    """
    ...
    logger.info(f"chat_with_context_streaming - transcript len: {len(transcript) if transcript else 0}, summary len: {len(summary) if summary else 0}")
