...
class ASRClient:
    ...
    async def send_config(self, ws, chunk_ms: int = None) -> None:
        """
    ...
    async def receive(self, ws, timeout: float = None) -> Optional[ASRResult]:
        """
    ...
    def _parse_response(self, message: str) -> Optional[ASRResult]:
        """
